...
public class FeedbackAdmin_POM extends BaseClass{
...
//testFeedbackPage	
	...
	public static By byHelpUsImprove						= By.id("rn_RequestUpdate_24_Description");
	...
	public static By bythumbsDownComments					= By.id("rn_AnswerRating_3_22_FeedbackMessage");
...
//testMyFeedbackStatus	
	...
	public static By byFeedbackResult						= By.xpath("(//tbody[@class='yui3-datatable-data']//a)[1]");
...
// testNavigateToFeedBackAdminReportFlow
...
// testSelectingandGivingAsnwerstoReportFlow 
			...
			public static By byCountHappyandSadXpath              = By.xpath("(//span[contains(@title,'Happy ')]//a)[1]");
			public static By byClickTopLevelXpath                 = By.xpath("(//ul[@class='breadcrumb']//a)[1]");
			public static By byClickContactsXpath                 = By.xpath("(//div[text()='Contacts']//a)");
			...
			public static By byClickContactIDXpath                = By.xpath("(//span[contains(@title,'Contact ID')])[2]");
			...
			//public static By byClickUserProfileXpath              = By.xpath("//div[@class='oj-avatar-initials oj-avatar-background-image']");
